...
#1.1 Importante dados e bibliotecas
"""
...
"""#1.2 visualizando a base de dados"""
...
"""#1.3 Analizando todos os Estados"""
...
"""#1.4 filtrando estados para comparações"""
...
"""#1.6 Comparações com um estado específico"""
...
"""#2.1 utilizando uma fonte externa com dados da população"""
...
"""#2.2 unindo os dados na mesma planilha"""
...
"""#2.3 Seaborn trazendo diferentes visualizações"""
...
"""#2.4 Criando comparações com valos por habitante"""
...
"""#2.5 iniciando análise de um estado por mes, dia e ano"""
...
axis = sns.lineplot(data=mensal_aberto, x="dia_mes_ano", y="gasto", hue="uf", palette=palette)
...
# precisa informar que a data não é object.
...
mensal_do_meu_estado.groupby("ano").sum()
...
#_r no rocket inverte os tons trazendo do mais claro para o mais escuro
paleta = sns.color_palette("rocket_r", 18)
sns.barplot(data=gastos_por_ano, x=gastos_por_ano.index, y="gasto", palette=paleta)

"""# 2.9 GROUP BY por estados"""

estados=["Amazonas", "Mato Grosso", "Ceará"]
por_ano_dos_estados = mensal_aberto.query("uf in @estados").groupby(["ano", "uf"]).sum()
...
sns.barplot(data=por_ano_dos_estados, x=por_ano_dos_estados.index, y="gasto", palette=paleta)

sns.lineplot(data=por_ano_dos_estados, x="ano", y="gasto", hue="uf")

sns.catplot(data=por_ano_dos_estados, x="ano", y="gasto", hue="uf")
...
paleta = sns.color_palette("rocket_r", 14)
sns.catplot(data=por_ano_dos_estados, x="ano", y="gasto", palette=paleta, col="uf", kind="bar")

paleta = sns.color_palette("rocket_r", 14)
sns.catplot(data=por_ano_dos_estados, x="ano", y="gasto", palette=paleta, row="uf", kind="bar")
